...
<head>
  ...
  <link rel = "stylesheet" href="/p2/yym/project_youja/sign_up.css">
  <title>sign_up</title>
  ...
  <div class="container">
    <div class="input-form-backgroud row">
      <div class="input-form col-md-12 mx-auto">
        ...
        <form class="validation-form" name = "sign_up" method="post" action="/p2/yym/project_youja/insert.php">
          <div class="row">
    ...
    <footer  class="my-3 text-center text-small">
      <a href = "/p2/yym/project_youja/index.php"><img src = "/p2/yym/project_youja/img/logo_2.png" width ="100rem"></a>
    </footer>
  </div>
  <script>
