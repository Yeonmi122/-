...
<head>
    ...
    <link rel = "stylesheet" href = "/p2/yym/project_youja/index.css">
...
<script>
	function check_password(mode, num) {
		// mode : modify(수정) delete(삭제), num : 레코드 번호
     	window.open("/p2/yym/project_youja/w_board/password_form.php?mode="+mode+"&num="+num,
         "pass_check",
...
<body> 
	...
	<ul class="buttons">
		<li><button onclick="location.href='/p2/yym/project_youja/w_board/list.php'">목록보기</button></li>
